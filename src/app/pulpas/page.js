...
const navigation = [
  ...
  { name: 'Pedidos', href: '#', icon: ViewListIcon, current: false },
                  ...
                  <span className="flex w-full justify-between items-center">
                    <span className="flex min-w-0 items-center justify-between space-x-3">
                      ...
                      <span className="flex-1 flex flex-col min-w-0">
                        <span className="text-gray-900 text-sm font-medium truncate">Omar Dominguez</span>
                        <span className="text-gray-500 text-sm truncate">@omidrumer</span>
                      </span>
                    </span>
                    <SelectorIcon
        ...
        <div className="lg:pl-64 flex flex-col">
          ...
          <main className="flex-1">
            ...
            <div className="px-4 mt-6 sm:px-6 lg:px-8">
              <h2 className="text-gray-500 text-xs font-medium uppercase tracking-wide">Pedidos</h2>
                  ...
                  <li key={project.id} className="relative col-span-1 flex shadow-sm rounded-md">
                    ...
                    <div className="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
                      <div className="flex-1 px-4 py-2 text-sm truncate">
                        ...
                        <p className="text-gray-500">{project.totalMembers} Kilos</p>
                      </div>
            ...
            <div className="mt-10 sm:hidden">
              <div className="px-4 sm:px-6">
                <h2 className="text-gray-500 text-xs font-medium uppercase tracking-wide">Pulpas</h2>
              </div>
              <ul role="list" className="mt-3 border-t border-gray-200 divide-y divide-gray-100">
                    ...
                    <a href="#" className="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
                      <span className="flex items-center truncate space-x-3">
                        ...
                        <span className="font-medium truncate text-sm leading-6">
                          Maracuya <span className="truncate font-normal text-gray-500">Existencia: 3</span>
                        </span>
                      </span>
                      <ChevronRightIcon
                  ...
                  <li>
                    <a href="#" className="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
                      <span className="flex items-center truncate space-x-3">
                        <span
                          className={' w-2.5 bg-slate-400 h-2.5 flex-shrink-0 rounded-full'}
                          aria-hidden="true"
                        />
                        <span className="font-medium truncate text-sm leading-6">
                          Guanabana <span className="truncate font-normal text-gray-500">Existencia: 3</span>
                        </span>
                      </span>
                      <ChevronRightIcon
                        className="ml-4 h-5 w-5 text-gray-400 group-hover:text-gray-500"
                  ...
                  <li>
                    <a href="#" className="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
                      <span className="flex items-center truncate space-x-3">
                        <span
                          className={'bg-yellow-400 w-2.5 h-2.5 flex-shrink-0 rounded-full'}
                          aria-hidden="true"
                        />
                        <span className="font-medium truncate text-sm leading-6">
                          Mango <span className="truncate font-normal text-gray-500">Existencia: 3</span>
                        </span>
                      </span>
                      <ChevronRightIcon
                        className="ml-4 h-5 w-5 text-gray-400 group-hover:text-gray-500"
                  ...
                  <li>
                    <a href="#" className="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
                      <span className="flex items-center truncate space-x-3">
                        <span
                          className={'bg-pink-400 w-2.5 h-2.5 flex-shrink-0 rounded-full'}
                          aria-hidden="true"
                        />
                        <span className="font-medium truncate text-sm leading-6">
                          Fresa <span className="truncate font-normal text-gray-500">Existencia: 3</span>
                        </span>
                      </span>
                      <ChevronRightIcon
                        className="ml-4 h-5 w-5 text-gray-400 group-hover:text-gray-500"
                  ...
                  <thead>
                    <tr className="border-t border-gray-200">
                      <th className="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <span className="lg:pl-2">Pulpas</span>
                      </th>
                      <th className="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        Members
                      </th>
